<%-- 
    ...
    Created on : Sep 18, 2020, 7:37:52 PM
    Author     : Saamu
--%>
 <% 
...
<jsp:include page="headers.jsp" flush="true"/>
         <div>
            <div class="row" id="allplots" style="margin: 5px;padding: 0px;">
            <ul id="myTab" class="nav nav-pills col-sm-12" style="text-align: center; ">
                <li class="active col-sm-2" style="padding:0;margin:0;" id="messagereceivedtabid" ><a href="#messagereceivedtab" data-toggle="tab">Received</a></li>
                <li class="col-sm-2" style="padding:0;margin:0;" id="messagesenttabid" ><a href="#messagesenttab" data-toggle="tab">Sent</a></li>
             </ul>  
                <div id="myTabContent" class="tab-content" style="margin-top: 1%;">
                    <div class="tab-pane fade in active" id="messagereceivedtab">
                    ...
                    <div class="tab-pane fade in" id="messagesenttab">
                        <div class="col-sm-12" style="padding: 5px;min-width: 300px;" id="">
                            <div class="well">                  
                                <div class="row">
                                    <div class="col-sm-12">
...
$(document).on('click','#messagesenttabid',(function(e){
        loadsentmessages();
  }));
